 ...
 const [isHoverred , setIsHoverred] = useState(false)
  ...
  return (
    ...
    <AnimatePresence>
      ...
      exit = {{opacity:0 , x:-25}}
      className=" hidden lg:block lg:absolute bg-white rounded-md px-6 py-2 -left-[140px] after:absolute after:-right-1 after:top-3 after:w-3 after:h-3 after:bg-white after:rotate-45 "
